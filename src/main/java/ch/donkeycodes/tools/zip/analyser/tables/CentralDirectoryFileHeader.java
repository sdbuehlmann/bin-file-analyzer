package ch.donkeycodes.tools.zip.analyser.tables;

import ch.donkeycodes.tools.zip.analyser.ReadableTable;
...
import ch.donkeycodes.tools.utils.IntegerUtils;
import ch.donkeycodes.tools.zip.analyser.tables.interpreted.CompressionMethod;
